        ...
        <div data-aos="fade-down" className="logo">
          ...
          >
            <div className="m-auto flex items-center justify-between">
              {/* <img
                src="/src/assets/photoperfil2.png"
                alt="logo"
                width="350"
                height="350"
              /> */}
        ...
        >
          ...
          >
            ...
            <a
              ...
              target="blank"
              className="bg-gradient-to-r from-blue-400 to-blue-700 text-white px-8 py-2 rounded-lg font-bold hover:text-yellow-400 md:m-5 md:block md:mx-auto md:w-fit lg:px-3"
            >
              CONTRATE-ME
            </a>
          </ul>
